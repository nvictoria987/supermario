...
class Level1(tools._State):
    ...
    def check_mario_y_collisions(self):
        ...
        brick = self.prevent_collision_conflict(brick)
    ...
    def prevent_collision_conflict(self, obstacle1):
    ...
    def check_enemy_y_collisions(self, enemy):
        ...
        if collider:
            ...
            enemy.rect.y += 1
            test_group = pg.sprite.Group(self.ground_step_pipe_group, self.brick_group)
